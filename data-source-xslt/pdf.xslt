...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;pdf&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="sample.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="15.24mm" margin-right="15.24mm" page-height="279.40mm" page-width="215.90mm" margin-top="7.62mm" margin-bottom="7.62mm">
				<fo:region-body margin-top="12.45mm" margin-bottom="12.45mm" column-count="1" column-gap="12.70mm"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="15.24mm" margin-right="15.24mm" page-height="279.40mm" page-width="215.90mm" margin-top="7.62mm" margin-bottom="7.62mm">
				<fo:region-body margin-top="12.45mm" margin-bottom="12.45mm" column-count="1" column-gap="12.70mm"/>
			</fo:simple-page-master>
							...
							<xsl:for-each select="$XML">
								<xsl:for-each select="transformation-input">
									<xsl:for-each select="parameters">
										<altova:line-break/>
										<xsl:choose>
											<xsl:when test="exists(parameter[(@name eq &apos;company_name&apos;) and (@value ne &apos;&apos;)])">
												<altova:line-break/>
												<xsl:variable name="altova:table">
													<fo:table table-layout="fixed" width="100%" border-spacing="2pt" altova:hide-rows="empty">
														<fo:table-column column-width="proportional-column-width(1)"/>
														<xsl:variable name="altova:CurrContextGrid_1" select="."/>
														<xsl:variable name="altova:ColumnData"/>
														<fo:table-body start-indent="0pt">
															<fo:table-row>
																<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block>
																		<altova:inline-container-substitute font-weight="bold">
																			<xsl:value-of select="parameter[@name eq &apos;company_name&apos;]/@value"/>
																		</altova:inline-container-substitute>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
															<xsl:choose>
																<xsl:when test="string-join(parameter[@name eq &apos;company_city&apos; or @name eq &apos;company_country&apos;]/@value,&apos;&apos;) ne &apos;&apos;">
																	<fo:table-row>
																		<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block>
																				<altova:inline-container-substitute>
																					<xsl:value-of select="string-join(parameter[@name eq &apos;company_city&apos; or @name eq &apos;company_country&apos;]/@value,&apos; / &apos;)"/>
																				</altova:inline-container-substitute>
																			</fo:block>
																		</fo:table-cell>
																	</fo:table-row>
															...
															<fo:table-row>
																<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block>
																		<altova:inline-container-substitute>
																			<xsl:value-of select="parameter[@name eq &apos;company_phone&apos;]/@value"/>
																		</altova:inline-container-substitute>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
															<fo:table-row>
																<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block>
																		<altova:inline-container-substitute>
																			<xsl:value-of select="parameter[@name eq &apos;company_website&apos;]/@value"/>
																		</altova:inline-container-substitute>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
											...
											<xsl:otherwise>
												<xsl:variable name="altova:table">
													<fo:table table-layout="fixed" width="100%" border-spacing="2pt" altova:hide-rows="empty">
														...
														<fo:table-body start-indent="0pt">
															<xsl:choose>
																<xsl:when test="string-join(parameter[@name eq &apos;contact_firstname&apos; or @name eq &apos;contact_lastname&apos;]/@value,&apos;&apos;) ne &apos;&apos;">
																	<fo:table-row>
																		<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block>
																				<altova:inline-container-substitute font-weight="bold">
																					<xsl:value-of select="string-join(parameter[@name eq &apos;contact_firstname&apos; or @name eq &apos;contact_lastname&apos;]/@value,&apos; &apos;)"/>
																				</altova:inline-container-substitute>
																			</fo:block>
																		</fo:table-cell>
																	</fo:table-row>
															...
															<fo:table-row>
																<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block>
																		<altova:inline-container-substitute>
																			<xsl:value-of select="parameter[@name eq &apos;contact_company&apos;]/@value"/>
																		</altova:inline-container-substitute>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
															<xsl:choose>
																<xsl:when test="string-join(parameter[@name eq &apos;contact_city&apos; or @name eq &apos;contact_country&apos;]/@value,&apos;&apos;) ne &apos;&apos;">
																	<fo:table-row>
																		<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block>
																				<altova:inline-container-substitute>
																					<xsl:value-of select="string-join(parameter[@name eq &apos;contact_city&apos; or @name eq &apos;contact_country&apos;]/@value,&apos; / &apos;)"/>
																				</altova:inline-container-substitute>
																			</fo:block>
																		</fo:table-cell>
																	</fo:table-row>
															...
															<fo:table-row>
																<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block>
																		<altova:inline-container-substitute>
																			<xsl:value-of select="parameter[@name eq &apos;contact_phone&apos;]/@value"/>
																		</altova:inline-container-substitute>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
															<fo:table-row>
																<fo:table-cell padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block>
																		<altova:inline-container-substitute>
																			<xsl:value-of select="parameter[@name eq &apos;contact_email&apos;]/@value"/>
																		</altova:inline-container-substitute>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
										...
										<fo:block margin-right="100% - 100%" font-size="2em" font-weight="bold" space-before="0.67em" space-after="0.67em" margin="0pt">
											<fo:inline>
												<xsl:text>List of Attributes</xsl:text>
											</fo:inline>
										</fo:block>
										<xsl:variable name="altova:table">
											<fo:table border-collapse="collapse" table-layout="fixed" width="100%">
												...
												<xsl:variable name="altova:ColumnData"/>
												<fo:table-body start-indent="0pt">
													<xsl:for-each select="parameter[(starts-with(@name,&apos;company_&apos;) or starts-with(@name,&apos;contact_&apos;)) and not(contains(@name,&apos;_hs_&apos;))]">
														<xsl:sort select="@name" data-type="text" order="ascending"/>
														<xsl:choose>
															<xsl:when test="@value ne &apos;&apos;">
																<fo:table-row>
																	<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" padding="2pt" display-align="center">
																		<fo:block>
																			<altova:inline-container-substitute>
										...
										<fo:block margin-right="100% - 100%" font-size="1.5em" font-weight="bold" space-before="0.75em" space-after="0.75em" margin="0pt">
											<fo:inline>
												<xsl:text>Internal Hubspot Attributes</xsl:text>
											</fo:inline>
										</fo:block>
										<altova:line-break/>
										<xsl:variable name="altova:table">
											<fo:table border-collapse="collapse" table-layout="fixed" width="100%">
												...
												<xsl:variable name="altova:ColumnData"/>
												<fo:table-body start-indent="0pt">
													<xsl:for-each select="parameter[(starts-with(@name,&apos;company_&apos;) or starts-with(@name,&apos;contact_&apos;)) and contains(@name,&apos;_hs_&apos;)]">
														<xsl:sort select="@name" data-type="text" order="ascending"/>
														<xsl:choose>
															<xsl:when test="@value ne &apos;&apos;">
																<fo:table-row>
